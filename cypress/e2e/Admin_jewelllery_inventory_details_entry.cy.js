describe('Admin Jewellery inventory - End-to-End Functional Test Suite', () => {
  ...
  it('Verify the Admin Dashboard loads successfully and the sidebar menu opens on click', () => {
    ...
    cy.wait(3000)
     ...
     it('Verify admin user can navigate to the Jewellery Inventory page successfully from the sidebar menu',()=>{
